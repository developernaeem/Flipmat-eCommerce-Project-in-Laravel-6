...
<div class="content-header">
	...
	<div class="leftside-content-header">
		<ul class="breadcrumbs">
			...
			<li><a href="javascript:avoid(0)">Category List</a></li>
		</ul>
	</div>
</div>
<!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
							...
							<tbody>
								...
								@foreach($showCategory as $category)
									<tr>
										...
										<td>
											<a href="{{ route('edit_category', $category->id ) }}" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a>
											<a href="{{ route('delete_category', $category->id ) }}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>
										</td>
									</tr>
								@php($i++)
								@endforeach
