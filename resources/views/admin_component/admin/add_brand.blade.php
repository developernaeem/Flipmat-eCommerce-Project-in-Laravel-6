				...
				<div class="panel-content">
					<div class="row">
						...
						<div class="col-xs-6 text-right">
							<a href="{{ route('manage_brand') }}" class="btn btn-primary">All Brand</a>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<form class="form-horizontal" action="{{ route('store_brand') }}" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="brand_name" class="form-control" id="brand_name" placeholder="Brand Name" required>
									</div>
								</div>
								<div class="form-group">
